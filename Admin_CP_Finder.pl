...
system('cls');
system('title Admin CP Finder(Dr.0rYX-Cr3W-DZ )');
system "color 0a";
print"\n";
print "\t>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>\n";
print "\t>  Admin CP Finder V1.0                   >\n";
print "\t>  Http://NORTH-AFRICA.com                >\n";
print "\t>  NORTH-AFRICA SECURITY TEAM  (N.A.S.T)  >\n";
print "\t>  ALGERIAN HACKERS MUSLIMS               >\n";
print "\t>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>\n";
print "\n";
